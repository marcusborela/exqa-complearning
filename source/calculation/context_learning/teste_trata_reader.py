from source.calculation.context_learning.trata_reader import Reader
...
def teste_context_reader():
    reader = Reader('models/context_learning/EleutherAI/gpt-neo-1.3B', parm_dict_config)
    #reader = Reader('models/context_learning/EleutherAI/gpt-j-6B', parm_dict_config)
    ##print(reader.info())
